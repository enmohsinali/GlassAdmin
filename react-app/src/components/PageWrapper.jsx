 ...
 * Reusable wrapper for all pages with Header, Sidebar, and Theme toggle
 * @param {string} title - Page title to display in the main header
 * @param {React.ReactNode} children - Page content to render
 * @param {boolean} showTabs - Whether to show Desktop/Mobile/Web tabs (default: false)
 */
            ...
            <div className={`main-header flex items-center border-b ${borderColor} h-[58px] flex-shrink-0`}>
              {showTabs ? (
                <>
                  <a
                    href="#"
                    className={`menu-link-main no-underline ${textColor} px-[30px] max-[1055px]:hidden`}
                  >
                    {title || 'All Apps'}
                  </a>
                  <div className="header-menu ml-[150px] max-[1055px]:m-auto">
                    <a
                      href="#"
                      className={`main-header-link is-active px-6 py-5 no-underline ${inactiveColor} border-b-2 ${isDark ? 'border-[#f9fafb]' : 'border-[#3c3a3a]'} transition-all-300 hover:${textColor}`}
                    >
                      Desktop
                    </a>
                    <a
                      href="#"
                      className={`main-header-link px-6 py-5 no-underline ${inactiveColor} border-b-2 border-transparent transition-all-300 hover:${textColor} hover:border-current`}
                    >
                      Mobile
                    </a>
                    <a

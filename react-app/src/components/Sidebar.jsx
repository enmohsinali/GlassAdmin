...
const Sidebar = ({ isMobileOpen, onClose }) => {
  ...
  return (
    <aside className={`left-side flex-none w-[240px] border-r ${borderColor} p-[26px] overflow-auto max-[945px]:fixed max-[945px]:top-0 max-[945px]:left-0 max-[945px]:h-full max-[945px]:z-50 max-[945px]:${bgColor} max-[945px]:backdrop-blur-[20px] max-[945px]:transition-transform max-[945px]:duration-300 ${isMobileOpen ? 'max-[945px]:translate-x-0' : 'max-[945px]:-translate-x-full'} md:translate-x-0`}>
      ...
      <button
        onClick={onClose}
        className={`md:hidden mb-4 w-10 h-10 rounded-full ${isDark ? 'bg-[rgba(113,119,144,0.2)]' : 'bg-[rgba(113,119,144,0.15)]'} backdrop-blur-md flex items-center justify-center ${textColor} hover:${isDark ? 'bg-[rgba(113,119,144,0.3)]' : 'bg-[rgba(113,119,144,0.25)]'} transition-all-300`}
      ...
      <div className="side-wrapper mt-5">
        <div className={`side-title ${inactiveColor} mb-3.5`}>Management</div>
        <div className="side-menu flex flex-col whitespace-nowrap">
          <Link
            to="/dashboard/orders"
            onClick={onClose}
            className={`flex items-center no-underline ${isActive('/dashboard/orders') ? `${textColor} ${activeBg}` : textColor} font-normal p-2.5 text-[14px] rounded-md transition-all-300 ${hoverBg}`}
          >
            <svg className="w-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link
            ...
            onClick={onClose}
            className={`flex items-center no-underline ${isActive('/dashboard/invoices') ? `${textColor} ${activeBg}` : textColor} font-normal p-2.5 text-[14px] rounded-md transition-all-300 ${hoverBg}`}
          >
            <svg className="w-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link
            ...
            onClick={onClose}
            className={`flex items-center no-underline ${isActive('/dashboard/settings') ? `${textColor} ${activeBg}` : textColor} font-normal p-2.5 text-[14px] rounded-md transition-all-300 ${hoverBg}`}
          >
            <svg className="w-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="side-wrapper mt-5">
        ...
        <div className="side-menu flex flex-col whitespace-nowrap">
          ...
          <a href="#" className={`flex items-center no-underline ${textColor} font-normal p-2.5 text-[14px] rounded-md transition-all-300 ${hoverBg}`}>
            ...
            Updates
            <span className="notification-number ml-auto relative top-0 right-0 w-[18px] h-[18px] text-[11px] bg-[#3a6df0] rounded-full flex items-center justify-center text-white">3</span>
          </a>
        </div>
      </div>
      ...
      {/* Categories Section */}
      <div className="side-wrapper mt-5">
        <div className={`side-title ${inactiveColor} mb-3.5`}>Categories</div>
        <div className="side-menu flex flex-col whitespace-nowrap">
          <a href="#" className={`flex items-center no-underline ${textColor} font-normal p-2.5 text-[14px] rounded-md transition-all-300 ${hoverBg}`}>
      ...
      {/* Fonts Section */}
      <div className="side-wrapper mt-5">
        <div className={`side-title ${inactiveColor} mb-3.5`}>Fonts</div>
        <div className="side-menu flex flex-col whitespace-nowrap">
          <a href="#" className={`flex items-center no-underline ${textColor} font-normal p-2.5 text-[14px] rounded-md transition-all-300 ${hoverBg}`}>
      ...
      <div className="side-wrapper mt-5">
        <div className={`side-title ${inactiveColor} mb-3.5`}>Resource Links</div>
        <div className="side-menu flex flex-col whitespace-nowrap">
          <a href="#" className={`flex items-center no-underline ${textColor} font-normal p-2.5 text-[14px] rounded-md transition-all-300 ${hoverBg}`}>
            <svg className="w-4 mr-2" viewBox="0 0 512 512" fill="currentColor">
